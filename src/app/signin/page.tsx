  ...
  return (
    <article className="w-[260px] shrink-0 rounded-2xl bg-white p-5 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)]">
      <div className="flex items-center gap-2.5">
        <div
          className={`grid h-9 w-9 place-items-center rounded-full bg-gradient-to-br ${r.color} text-[12px] font-bold text-white`}
        >
          {r.name[0]}
        </div>
...
export default function SignInPage() {
  ...
  function handleEmail(e: React.FormEvent) {
    ...
    store.signIn(trimmed);
    router.push("/app");
  }

  function handleGoogle() {
    // mock Google login
    store.signIn("vaishalsparikh@gmail.com");
    router.push("/app");
  }
        ...
        <div className="mx-auto flex w-full max-w-[400px] flex-1 items-center">
          <div className="w-full rounded-2xl border border-neutral-200 bg-white p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.06)]">
            ...
            <button
              ...
              className="mt-6 flex w-full items-center justify-center gap-2.5 rounded-lg bg-neutral-950 py-3 text-[14px] font-semibold text-white transition hover:bg-neutral-800"
            >
