    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto px-8 py-8">
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-[1.2fr_1.6fr_70px_1.2fr_0.6fr_1fr_180px] items-center gap-4 border-b border-neutral-200 pb-3 text-[12.5px] font-semibold text-neutral-700">
            <div>Title</div>
            <div>Description</div>
            <div>Mode</div>
            <div>Ends In</div>
          ...
          {sessions.length === 0 ? (
            ...
            sessions.map((s) => (
              <div
                key={s.id}
                className="grid grid-cols-[1.2fr_1.6fr_70px_1.2fr_0.6fr_1fr_180px] items-center gap-4 border-b border-neutral-100 py-4 text-[14px]"
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="grid h-8 w-8 place-items-center rounded-md border border-neutral-200 bg-white text-neutral-500 transition hover:border-rose-200 hover:bg-rose-50 hover:text-rose-600"
      ...
      {/* Delete confirmation */}
      {deleteFor && (() => {
        const s = sessions.find((x) => x.id === deleteFor);
        if (!s) {
          setDeleteFor(null);
          return null;
        }
        return (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <div className="absolute inset-0 bg-black/40" onClick={() => setDeleteFor(null)} />
            <div className="relative w-full max-w-[420px] rounded-2xl bg-white p-7 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h2 className="text-[16px] font-bold text-neutral-950">Delete this session?</h2>
                  ...
                  <p className="mt-2 text-[12.5px] text-neutral-500">
                    This permanently removes the session, its transcript, and AI usage history. This action can&apos;t be undone.
                  </p>
                </div>
              </div>
              <div className="mt-5 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-rose-600 px-4 py-2 text-[13px] font-semibold text-white transition hover:bg-rose-700"
                >
                  Delete session
                </button>
              </div>
